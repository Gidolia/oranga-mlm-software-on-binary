...
function password_generate($chars) 
{
  ...
  return substr(str_shuffle($data), 0, $chars);
    ...
    $d_id=password_generate(15);
        		...
        		{
                    $inse="INSERT INTO `front_top_leader` (`ftl_id`, `date`, `name`, `place`, `photo`, `message`) VALUES (NULL, '$date', '$_POST[name]', '$_POST[place]', '$d_id', '$_POST[message]');";
                    if($con->query($inse)===TRUE)
                    {
                         echo "<script>alert('Success! Entered Successfully');location.href='top_leaders.php';</script>";
                    }
                }
            }
            ?>
                    ...
                    <div class="card-box table-responsive"> 
                     <table id="datatable-buttons" class="table table-striped jambo_table" >
                      ...
                      <tbody>
                          <?php 
                                $au=1;
                                $e="SELECT * FROM `front_top_leader`";
                                $d=$con->query($e);
                                ...
                                <td>
                                 ...
                                 <td>
                                     <a href="process_del_top_leader.php?id=<?php echo $R[ftl_id]; ?>" class="btn btn-danger">Delete</a>
                                 </td>
                                </tr>
                                <?php 
                                } ?>
