...
<html lang="en">
  <head>
    ...
    <title>ORANGA || Profile Edit</title>
                     ...
                     if(isset($_POST[submit_profile]))
                     {
                        ...
                        if(move_uploaded_file($_FILES["pan"]["tmp_name"], "profile_photo/".$_SESSION['d_id'].".jpg"))
                		{
                            echo "Stored in: " . "profile_photo/".$fileName;
                             ...
                             {
                                 echo "<script>alert('Success! Updated Successfully');location.href='index.php';</script>";
                             }
                             else{
                                 echo "<script>alert('Failed! Plz try Again');location.href='change_profile_photo.php';</script>";
                             }
                        }
                     }
                     ?>
