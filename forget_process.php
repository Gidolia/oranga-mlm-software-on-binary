...
<head>
  ...
  <title>Password Detail || Oranga Business</title>
...
if(isset($_POST[sub_pass]))
    ...
    {
     $re="SELECT * FROM `distributor` WHERE `d_id`='$d_id'";
            $fd=$con->query($re);
            $fet=$fd->fetch_assoc();
    ...
    echo "<script>alert('Invalid USERID ');
...
?>
            ...
            <table class="text-center table" align="center" style="background-color: aliceblue; opacity: 0.7;">
                <tr><td>Your Password is Successfully Sended to your Linked Mobile Number</td></tr>
