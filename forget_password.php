...
<head>
  ...
  <title>Forget Password || Oranga Business</title>
      ...
      <div class="container h-100">
        <div class="row justify-content-center align-items-center h-100">
          ...
          <div class="col-lg-8">
            ...
            <h1 class="fg-white text-center">Forget Password</h1>
          </div>
          <!---->
           <div class="row justify-content-center mt-5">
          <div class="col-lg-8">
            <form class="form-contact" method="post" action="forget_process.php">
              <div class="row">
                ...
                <div class="col-12 mt-3">
                  <input type="submit" name="sub_pass" class="btn btn-primary px-5" value="Submit">
                </div>
